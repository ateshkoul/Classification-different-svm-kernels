...
function [accTest, accCv] = kinematicsvm_param(Data)
...
for folds=1:nfold
    ...
    for i = 1:numLog2c
        ...
        for j = 1:numLog2g
            ...
            param = ['-m 2000 -q -t 1 -v 3 -c ', num2str(2^log2c), ' -g ', num2str(2^log2g)];
    ...
    param = ['-m 2000 -q -t 1 -c ', num2str(2^bestLog2c), ' -g ', num2str(2^bestLog2g), ' -b 1'];
